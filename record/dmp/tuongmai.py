...
class TestA(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(self):
        self.api_base_url                   = tuongmaicfg.BASE_URL or 'http://api.dailymotion.com'
        self.api_key                        = tuongmaicfg.CLIENT_ID
        self.api_secret                     = tuongmaicfg.CLIENT_SECRET
        self.username                       = tuongmaicfg.USERNAME
        self.password                       = tuongmaicfg.PASSWORD
        self.scope                          = ['manage_videos', 'manage_playlists', 'userinfo']
        self.redirect_uri                   = tuongmaicfg.REDIRECT_URI
        self.oauth_authorize_endpoint_url   = tuongmaicfg.OAUTH_AUTHORIZE_URL or 'https://api.dailymotion.com/oauth/authorize'
        self.oauth_token_endpoint_url       = tuongmaicfg.OAUTH_TOKEN_URL or 'https://api.dailymotion.com/oauth/token'
